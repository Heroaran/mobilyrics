const scores = [
      ...
      },
      {
        title: "따잇하는 재미",
        composer: "메벤남",
        instrument: "만돌린, 샬루모, 바이올린, 플루트",
        difficulty: "4화음",
        tags: ["창팝", "메이플", "신창섭", "메벤남", "밈"],
        url: "https://gall.dcinside.com/enban/4125",
        solo: true
      },
      {
        title: "String Theocracy(실의 신권정치)",
        composer: "Mili",
        instrument: "피아노, 실로폰, 샬루모, 류트",
        difficulty: "6화음",
        tags: ["라이브러리 오브 루이나", "OST"],
      ...
      },
      {
        ...
        instrument: "만돌린, 바이올린",
        difficulty: "4화음",
        tags: ["어택온티탄", "진격의거인", "진격거", "OST", "애니"],
        url: "https://gall.dcinside.com/enban/25381",
        solo: true
      },
      {
        title: "Vogel im Kafig(새장속의 새)",
        composer: "진격의거인",
        instrument: "만돌린",
        difficulty: "3화음",
        tags: ["어택온티탄", "진격의거인", "진격거", "OST", "애니"],
      ...
      },
      {
        ...
        instrument: "피아노",
        difficulty: "3화음",
        tags: ["피아노곡", "클래식", "리듬게임", "Plum"],
        url: "https://gall.dcinside.com/enban/381462",
        solo: true
      },
      {
        title: "과거의 물결 - 붕괴 스타레일「안녕, 세상아!」삽입곡",
        composer: "HoYoverse",
        instrument: "피아노",
        difficulty: "6화음",
        tags: ["호요버스", "붕괴", "게임"],
      ...
      {
        title: "바람이 되어 - 고양이의 보은 OST",
        composer: "츠지 아야노",
        instrument: "만돌린",
        difficulty: "3화음",
        tags: ["고양이의 보은", "JPOP", "OST"],
      ...
      {
        title: "트리 오브 세이비어 - Charty of fire",
        composer: "NEXON",
        instrument: "피아노, 바이올린, 만돌린, 큰북",
        difficulty: "12화음",
        tags: ["트오세", "넥슨", "게임"],
       ...
       {
        title: "모비노기 미스틱 던전 BGM",
        composer: "데브캣",
        instrument: "만돌린, 바이올린, 플루트, 샬루모",
        difficulty: "4화음",
        tags: ["마비노기 모바일", "미스틱 던전", "모비노기"],
      ...
      {
        title: "모비노기 보스 처형곡 미래를 손에 쥐다(Raid ver.)",
        composer: "데브캣",
        instrument: "만돌린, 큰북, 바이올린, 샬루모",
        difficulty: "4화음",
        tags: ["마비노기 모바일", "레이드", "모비노기"],
      ...
      },
      {
        ...
        instrument: "피아노",
        difficulty: "3화음",
        tags: ["클래식", "리듬게임", "Neal K"],
        url: "https://gall.dcinside.com/enban/84090",
        solo: true
      },
      {
        title: "글라스기브넨 최종무곡 (글라스기브넨)",
        composer: "데브캣",
        instrument: "만돌린, 바이올린, 플루트, 샬루모",
        difficulty: "4화음",
        tags: ["마비노기 모바일", "레이드", "모비노기", "글라스기브넨", "마비노기"],
...
{
  title: "엘더스크롤 스카이림 - The Dragonborn comes",
  composer: "엘더스크롤 V: 스카이림",
  instrument: "피아노",
  difficulty: "4화음",
  tags: ["엘더스크롤", "스카이림", "독주가능", "게임 ost"],
  url: "https://gall.dcinside.com/mgallery/board/view/?id=enban&no=475251&search_head=40&page=1",
  solo: true
},
{
  title: "메이플스토리 - 루디브리엄 가는 길 (Flying in a blue dream)",
  composer: "NEXON",
  instrument: "피아노",
  difficulty: "4화음",
  tags: ["메이플스토리", "합주추천", "넥슨"],
...
{
  title: "테일즈 오브 판타지아 - The Second Act",
  composer: "테일즈 오브 판타지아",
  instrument: "샬루모, 실로폰, 류트, 피아노, 만돌린",
  difficulty: "4화음",
  tags: ["여러악기합주추천", "반다이남코", "테일즈오브시리즈", "플레이스테이션", "일본게임"],
  url: "https://gall.dcinside.com/mgallery/board/view?id=mabinogimobile&no=832030",
  solo: true
},
{
  title: "임형주 - 천개의 바람이 되어",
  composer: "임형주",
  instrument: "류트, 피아노",
  difficulty: "5화음",
  tags: ["장송곡", "독주가능", "임형주"],
